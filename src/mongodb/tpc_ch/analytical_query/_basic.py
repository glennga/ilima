...
class BasicAnalyticalQuery(AbstractQueryRunnable):
    ...
    def perform_benchmark(self):
        ...
        for i in range(self.config['num_queries']):
            ...
            # Execute all queries from query set 1.
            self._execute_and_log(self.query_1, 1, i + 1, timeout=1800 * 1000, date_1=date_1, date_2=date_2)
            self._execute_and_log(self.query_6, 6, i + 1, timeout=1800 * 1000, date_1=date_1, date_2=date_2)
            self._execute_and_log(self.query_12, 12, i + 1, timeout=1800 * 1000, date_1=date_1, date_2=date_2)
            self._execute_and_log(self.query_14, 14, i + 1, timeout=1800 * 1000, date_1=date_1, date_2=date_2)
